...
var CreateSocietyMemberComponent = /** @class */ (function () {
    function CreateSocietyMemberComponent(formBuilder, _servive, _routet) {
    ...
    CreateSocietyMemberComponent.prototype.isFieldValid = function (form, field) {
        return !form.get(field).valid && form.get(field).touched;
    };
    CreateSocietyMemberComponent.prototype.displayFieldCss = function (form, field) {
        return {
            'has-error': this.isFieldValid(form, field),
            'has-feedback': this.isFieldValid(form, field)
        };
    };
    Object.defineProperty(CreateSocietyMemberComponent.prototype, "Beneficiary", {
        ///////////////////////////////////////////////////////////////////////////////////////
        get: function () {
    ...
    CreateSocietyMemberComponent.prototype.addBeneficiary = function () {
        this.Beneficiary.push(this.formBuilder.control(['']));
    };
    CreateSocietyMemberComponent.prototype.removeBeneficiary = function (index) {
        this.type.controls.beneficiary["controls"].splice(index, 1);
    };
    ///////////////////////////////////////////////////////////////////////////////////////
    CreateSocietyMemberComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CreateSocietyMemberComponent.prototype.ngOnChanges = function (changes) {
        var input = $(this);
        if (input[0].files && input[0].files[0]) {
            var reader = new FileReader();
            reader.onload = function (e) {
    ...
    CreateSocietyMemberComponent.prototype.ngAfterViewInit = function () {
    ...
    CreateSocietyMemberComponent = __decorate([
        Component({
        ...
        __metadata("design:paramtypes", [FormBuilder, ServiceService, Router])
    ], CreateSocietyMemberComponent);
    return CreateSocietyMemberComponent;
}());
export { CreateSocietyMemberComponent };
//# sourceMappingURL=CreateSocietyMember.component.js.map